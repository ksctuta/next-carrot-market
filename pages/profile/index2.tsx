  ...
  return (
    <>
      <div className="flex items-center mt-4 space-x-3">
        {/* https://imagedelivery.net/CAE7DwWZfF7RxYc9xx_P_A/<image_id>/<variant_name> */}
        {/* <div className="w-16 h-16 bg-slate-500 rounded-full" /> */}
        {user?.avatar ? (
          <img
            src={`https://imagedelivery.net/CAE7DwWZfF7RxYc9xx_P_A/${user?.avatar}/avatar`}
...
const Profile: NextPage = () => {
  return (
    <Layout hasTabBar title="나의 캐럿" seoTitle="나의 캐럿">
      <div className="px-4">
        <Suspense fallback="Loading MiniProfile...">
          <MiniProfile />
        </Suspense>
...
// ssuspanse 사용 할 때  안할때 부분 하단 주석처리함.
const Page: NextPage = () => {
  return (
    <SWRConfig
      value={{
    ...
    >
      {/* <Suspense fallback={<span>...Loaing...</span>}> */}
      <Profile />
      {/* </Suspense> */}
    </SWRConfig>
  );
